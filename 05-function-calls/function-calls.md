...
<iframe src="https://adaacademy.hosted.panopto.com/Panopto/Pages/Embed.aspx?id=3ae487ad-99fc-41fd-ba79-aad60060e313&autoplay=false&offerviewer=true&showtitle=true&showbrand=false&start=0&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay"></iframe>
...
- [Assignment](https://github.com/Ada-C14/recursion-tracing) - No PR Needed
...
* type: custom-snippet
* language: ruby
* id: 65e27d6e-43d0-40e1-ab70-ae1bea84ef3e
* title: Recursive Methods
* docker_directory_path: /custom-snippets/recursive-method-1
* points: 1
* topics: recursion
...
When you are ready you can see a [solution](natural-sum.resource.md) to both a recursive and iterative solution.
